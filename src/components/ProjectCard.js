...
export default function ProjectCard({ name, imgCover }) {
    return (
        <StyledProjectCard>
            <div className="card projectCard">
                <h2 className="card-title px-4 pt-4 mb-1">{name}</h2>
                <div className="card-body px-4 pb-4 row">
                    <div className="col-6 d-flex flex-column py-0 justify-content-start">
                        <p className="py-2">Using technologies like some text text text Using technologies like some text text text Using technologies like some text text text Using technologies like some text text</p>
                        <StyledTechSection>
